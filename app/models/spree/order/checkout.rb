        ...
        klass.class_eval do
            ...
            state_machine :state, initial: :cart, use_transactions: false, action: :save_state do
              ...
              event :return do
                transition to: :returned,
                           from: %i[complete awaiting_return canceled returned resumed],
              ...
              if states[:payment]
                ...
                before_transition to: :payment, do: :execute_stock_api
              end
          ...
          def assign_default_addresses!
            if user
              ...
              if !ship_address_id && user.ship_address&.valid? && checkout_steps.include?('delivery')
          ...
          def update_params_payment_source
            if @updating_params[:payment_source].present?
              ...
              @updating_params[:order][:payments_attributes].first[:source_attributes] = source_params if source_params
            end
