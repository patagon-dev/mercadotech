      ...
      class MallInscription
        ...
        class << self
          def start(user_name:, email:, response_url:, options: nil)
            ...
            return ::Transbank::Webpay::Oneclick::MallInscriptionStartResponse.new(body) if resp.is_a? Net::HTTPSuccess
          ...
          def finish(token:, options: nil)
            ...
            body = JSON.parse(resp.body)
            return ::Transbank::Webpay::Oneclick::MallInscriptionFinishResponse.new(body) if resp.is_a? Net::HTTPSuccess
          ...
          def delete(tbk_user:, user_name:, options: nil)
            ...
            code = resp.code
            return ::Transbank::Webpay::Oneclick::MallInscriptionDeleteResponse.new(code) if resp.is_a? Net::HTTPSuccess
