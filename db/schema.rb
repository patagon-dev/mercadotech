...
ActiveRecord::Schema.define(version: 2021_04_05_064139) do
  ...
  create_table "spree_addresses", id: :integer, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.string "customer_warehouse_code"
    t.string "label"
  ...
  create_table "spree_authentication_methods", id: :integer, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "spree_bank_accounts", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.string "guest_user_email"
    t.index ["bank_id"], name: "index_spree_bank_accounts_on_bank_id"
    t.index ["user_id"], name: "index_spree_bank_accounts_on_user_id"
  end

  create_table "spree_banks", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "name"
    t.string "code"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  ...
  create_table "spree_counties", id: :integer, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "name"
    t.integer "state_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "spree_customer_purchase_orders", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "purchase_order_number"
    t.bigint "vendor_id"
    t.bigint "order_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["order_id"], name: "index_spree_customer_purchase_orders_on_order_id"
    t.index ["vendor_id"], name: "index_spree_customer_purchase_orders_on_vendor_id"
  end
  ...
  create_table "spree_customer_returns", id: :integer, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["vendor_id"], name: "index_spree_customer_returns_on_vendor_id"
  end

  create_table "spree_enviame_carrier_services", charset: "latin1", force: :cascade do |t|
    t.string "name"
    t.string "code"
    t.string "description"
    t.boolean "default"
    t.bigint "enviame_carrier_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["enviame_carrier_id"], name: "index_spree_enviame_carrier_services_on_enviame_carrier_id"
  end

  create_table "spree_enviame_carriers", charset: "latin1", force: :cascade do |t|
    t.string "name"
    t.string "code"
    t.string "country"
    t.datetime "created_at", precision: 6, null: false
  ...
  create_table "spree_enviame_carriers_vendors", charset: "latin1", force: :cascade do |t|
    t.bigint "enviame_carrier_id"
    t.bigint "vendor_id"
    t.index ["enviame_carrier_id"], name: "index_spree_enviame_carriers_vendors_on_enviame_carrier_id"
    t.index ["vendor_id"], name: "index_spree_enviame_carriers_vendors_on_vendor_id"
  end
  ...
  create_table "spree_invoices", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "number"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.boolean "via_superfactura", default: false
    t.bigint "order_id"
    t.bigint "vendor_id"
    t.index ["order_id"], name: "index_spree_invoices_on_order_id"
    t.index ["vendor_id"], name: "index_spree_invoices_on_vendor_id"
  end

  create_table "spree_khipu_payment_receipts", id: :integer, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "spree_lists", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "key"
    t.string "name"
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["store_id"], name: "index_spree_lists_on_store_id"
  end
  ...
  create_table "spree_micro_compra_purchase_orders", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.integer "status"
    t.index ["order_id"], name: "index_spree_micro_compra_purchase_orders_on_order_id"
    t.index ["vendor_id"], name: "index_spree_micro_compra_purchase_orders_on_vendor_id"
  end
  ...
  create_table "spree_orders", id: :integer, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.decimal "taxable_adjustment_total", precision: 10, scale: 2, default: "0.0", null: false
    t.decimal "non_taxable_adjustment_total", precision: 10, scale: 2, default: "0.0", null: false
    t.string "reference_order_numbers"
  ...
  create_table "spree_pages", id: :integer, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "title"
    t.text "body"
    t.string "slug"
    t.datetime "created_at", null: false
  ...
  create_table "spree_pages_stores", id: false, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "store_id"
    t.integer "page_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "spree_payments", id: :integer, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.json "webpay_params"
    t.string "webpay_trx_id"
    t.boolean "accepted"
    t.string "webpay_token"
    t.json "webpay_capture_params"
    t.bigint "vendor_id"
    t.string "khipu_trx_id"
    t.boolean "amount_refunded", default: false
  ...
  create_table "spree_products", id: :integer, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.string "etilize_id"
    t.json "datasheet"
    t.boolean "skip_full_import", default: false
    t.boolean "skip_quick_import", default: false
    t.index ["available_on"], name: "index_spree_products_on_available_on"
    t.index ["deleted_at"], name: "index_spree_products_on_deleted_at"
    t.index ["discontinue_on"], name: "index_spree_products_on_discontinue_on"
    t.index ["etilize_id"], name: "index_spree_products_on_etilize_id"
    t.index ["name"], name: "index_spree_products_on_name"
    t.index ["partnumber"], name: "index_spree_products_on_partnumber"
  ...
  create_table "spree_promotion_rules_stores", id: false, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "promotion_rule_id"
    t.integer "store_id"
  end
  ...
  create_table "spree_refund_histories", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.json "refund_response"
    t.string "transaction_id"
    t.string "status"
    t.json "failure_reason"
    t.index ["reference_number"], name: "index_spree_refund_histories_on_reference_number"
    t.index ["user_id"], name: "index_spree_refund_histories_on_user_id"
    t.index ["vendor_id"], name: "index_spree_refund_histories_on_vendor_id"
  end
  ...
  create_table "spree_return_authorizations", id: :integer, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.boolean "request_pickup", default: false
    t.date "pickup_date"
    t.integer "range_time", default: 0
    t.boolean "pickup_generated", default: false
    ...
    t.index ["vendor_id"], name: "index_spree_return_authorizations_on_vendor_id"
  end
  ...
  create_table "spree_shipment_labels", charset: "latin1", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.integer "return_authorization_id"
    t.index ["shipment_id"], name: "index_spree_shipment_labels_on_shipment_id"
  end
  ...
  create_table "spree_shipments", id: :integer, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.decimal "taxable_adjustment_total", precision: 10, scale: 2, default: "0.0", null: false
    t.decimal "non_taxable_adjustment_total", precision: 10, scale: 2, default: "0.0", null: false
    t.integer "n_packages", default: 1
    t.bigint "enviame_carrier_id"
    t.bigint "enviame_carrier_service_id"
    t.string "reference_number"
    t.string "moova_shipment_id"
    t.index ["address_id"], name: "index_spree_shipments_on_address_id"
    t.index ["enviame_carrier_id"], name: "index_spree_shipments_on_enviame_carrier_id"
    t.index ["enviame_carrier_service_id"], name: "index_spree_shipments_on_enviame_carrier_service_id"
  ...
  create_table "spree_stock_locations", id: :integer, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.string "admin_name"
    t.integer "vendor_id"
    t.string "enviame_warehouse_code"
    t.boolean "skip_from_import", default: false
    t.string "google_place_id"
    t.decimal "latitude", precision: 10, scale: 6
    t.decimal "longitude", precision: 10, scale: 6
    t.boolean "rma_default", default: false
  ...
  create_table "spree_store_admin_users", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "store_id"
    t.bigint "user_id"
    t.index ["store_id", "user_id"], name: "index_spree_store_admin_users_on_store_id_and_user_id", unique: true
    t.index ["store_id"], name: "index_spree_store_admin_users_on_store_id"
    t.index ["user_id"], name: "index_spree_store_admin_users_on_user_id"
  end

  create_table "spree_store_authentication_types", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "store_id"
  ...
  create_table "spree_store_credit_events", id: :integer, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.decimal "user_total_amount", precision: 10, default: "0", null: false
    t.integer "originator_id"
    t.string "originator_type"
    t.datetime "deleted_at"
    t.datetime "created_at", precision: 6, null: false
  ...
  create_table "spree_store_credits", id: :integer, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.decimal "amount_used", precision: 10, default: "0", null: false
    t.text "memo"
    t.datetime "deleted_at"
    t.string "currency"
    t.decimal "amount_authorized", precision: 10, default: "0", null: false
    t.integer "originator_id"
    t.string "originator_type"
    t.integer "type_id"
    t.datetime "created_at", precision: 6, null: false
  ...
  create_table "spree_store_shipping_methods", id: :integer, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "store_id"
    t.integer "shipping_method_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "spree_stores", id: :integer, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.boolean "require_company_info_in_address"
    t.string "invoice_types", default: "--- []\n"
    t.boolean "maintenance_mode", default: false
    t.text "maintenance_message"
    t.boolean "show_included_tax", default: false
    t.text "comment_tool"
  ...
  create_table "spree_user_authentications", id: :integer, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "user_id"
    t.string "provider"
    t.string "uid"
    t.datetime "created_at", null: false
  ...
  create_table "spree_variants", id: :integer, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.integer "vendor_id"
    t.boolean "by_pass_stock", default: false
    t.string "name"
  ...
  create_table "spree_variants_volume_price_models", id: :integer, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "spree_vendor_tags", charset: "latin1", force: :cascade do |t|
    t.text "text"
    t.string "color"
    t.bigint "vendor_id"
    t.index ["vendor_id"], name: "index_spree_vendor_tags_on_vendor_id"
  end
  ...
  create_table "spree_vendors", id: :integer, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.string "ticket_id"
    t.string "address"
    t.string "webpay_ws_mall_store_code"
    t.string "phone"
    t.string "products_csv_url"
    t.datetime "products_imported_at"
    t.string "superfactura_login"
    t.string "superfactura_password"
    t.string "superfactura_environment"
    t.integer "invoice_options", default: 0
    t.string "products_xml_url"
    t.datetime "products_xml_imported_at"
    t.boolean "enable_khipu"
    t.string "khipu_id"
    t.string "khipu_secret"
    t.integer "enviame_vendor_id"
    t.string "import_store_ids", default: "---\n- '1'\n- '2'\n- '7'\n"
    t.integer "import_options", default: 0
    t.datetime "scrapinghub_imported_at"
    t.string "scrapinghub_api_key"
    t.string "scrapinghub_project_id"
    t.string "full_spider"
    t.string "quick_spider"
    t.boolean "set_minimum_order", default: false
    t.decimal "minimum_order_value", precision: 12, scale: 2
    t.boolean "enable_moova", default: false
    t.string "moova_api_key"
    t.string "moova_api_secret"
    t.boolean "enable_bank_transfer", default: false
    t.string "bank_transfer_url"
    t.string "bank_transfer_login"
    t.string "bank_transfer_password"
    t.string "webpay_oneclick_store_code"
    t.boolean "update_all_product", default: false
  ...
  create_table "spree_volume_price_models", id: :integer, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at"
    t.datetime "updated_at"
  end

  create_table "spree_volume_prices", id: :integer, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "variant_id"
    t.string "name"
    t.string "range"
    t.decimal "amount", precision: 10
  ...
  create_table "spree_wished_products", id: :integer, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "variant_id"
  ...
  create_table "spree_wishlists", id: :integer, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "user_id"
    t.string "name"
  ...
  create_table "spree_zones", id: :integer, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.boolean "is_moova", default: false
    t.index ["default_tax"], name: "index_spree_zones_on_default_tax"
    t.index ["kind"], name: "index_spree_zones_on_kind"
  end

  create_table "webpay_oneclick_mall_users", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.text "tbk_user"
    ...
    t.string "shares_number", default: "1"
  end
